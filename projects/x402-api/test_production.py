#!/usr/bin/env python3
# Test real API call with production mode

import json
import base64
import urllib.request

# Prepare mock payment proof
proof = {
    "tx_hash": "0x" + "a" * 64,
    "amount": "0.05",
    "sender": "0x" + "1" * 40,
    "recipient": "0x742d35Cc6634C0532925a3b844Bc9e7595f0bEb",
    "timestamp": "2026-03-02T19:15:00"
}
proof_b64 = base64.b64encode(json.dumps(proof).encode()).decode()

# Test code audit
url = "http://8.213.149.224:5001/api/v1/code-audit"
